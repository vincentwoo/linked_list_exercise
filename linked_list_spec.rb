...
describe LinkedList do
  ...
  describe '#push' do
    # push should maintain order, pushing 1 and 2 should have
    # the first and second members be 1 and 2 respectively
  end
  ...
  describe '#to_a' do
    # to_a returns a copy of the linked list expressed as a normal array
  end
